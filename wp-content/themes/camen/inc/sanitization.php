 ...
 */
function gco_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function gco_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function gco_sanitize_email( $email, $setting ) {
 ...
 */
function gco_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function gco_sanitize_html( $html ) {
 ...
 */
function gco_sanitize_image( $image, $setting ) {
 ...
 */
function gco_sanitize_nohtml( $nohtml ) {
 ...
 */
function gco_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function gco_sanitize_number_range( $number, $setting ) {
 ...
 */
function gco_sanitize_select( $input, $setting ) {
 ...
 */
function gco_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function gco_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function gco_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}